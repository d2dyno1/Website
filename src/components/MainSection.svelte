			...
			<Flex gap id="main-button-container" wrap>
				{#await getReleaseVersion()}
					<MainSectionButton title="Downloading ..." description="Fetching version..."
					                   href="ms-windows-store://pdp/?ProductId={storeId}" type={"primary"}>
				...
				<MainSectionButton description="Files is open source!" href="https://github.com/{org}/{repo}/" title="GitHub">
